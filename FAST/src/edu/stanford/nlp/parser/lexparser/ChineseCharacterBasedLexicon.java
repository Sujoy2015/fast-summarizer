...
public class ChineseCharacterBasedLexicon implements Lexicon {
  ...
  public void train(Collection<Tree> trees) {
    ...
    ClassicCounter charCounter = new ClassicCounter();
  ...
  public float score(IntTaggedWord iTW, int loc) {
    ...
    List charList = new ArrayList(chars.length + CONTEXT_LENGTH + 1); // this starts of storing Symbol's and then starts storing String's. Clean this up someday!
